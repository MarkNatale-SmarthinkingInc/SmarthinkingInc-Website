              ...
              <PrismicNextLink document={work} className="st-grid">
                <figure className="st-xl-4 st-xs-9 img-left">
                  <img
                    ...
                    src={`${work.data.homepage_image_1?.url}&fit=clip&w=1920&q=85`}
                    srcSet={[
                      `${work.data.homepage_image_1?.url}&fit=clip&w=768&q=85 768w`,
                      `${work.data.homepage_image_1?.url}&fit=clip&w=1024&q=85 1024w`,
                      `${work.data.homepage_image_1?.url}&fit=clip&w=1440&q=85 1440w`,
                      `${work.data.homepage_image_1?.url}&fit=clip&w=1920&q=85 1920w`,
                    ].join(", ")}
                    sizes="
  ...
  "
                ...
                <figure className="st-xl-4 xs-hidden img-right">
                  <img
                    ...
                    src={`${work.data.homepage_image_2?.url}&fit=clip&w=1920&q=85`}
                    srcSet={[
                      `${work.data.homepage_image_2?.url}&fit=clip&w=768&q=85 768w`,
                      `${work.data.homepage_image_2?.url}&fit=clip&w=1024&q=85 1024w`,
                      `${work.data.homepage_image_2?.url}&fit=clip&w=1440&q=85 1440w`,
                      `${work.data.homepage_image_2?.url}&fit=clip&w=1920&q=85 1920w`,
                    ].join(", ")}
                    sizes="
    (max-width: 767px) 100vw,
    (max-width: 1023px) 768px,
